...
if [ ! -e "api_ultrasonic_get_distance" ]; then
    echo "Application file api_ultrasonic_get_distance does not exist."
...
cp ./api_ultrasonic_get_distance_test /cygdrive/H/ev3rt/apps
